...
public class AppTest {
    ...
    static public String USER_NAME = "Adrian";
    static public String USER_SURNAME = "Petcu";
    static public String USER_EMAIL = "petcuadrian2002@gmail.com";
    static public String USER_GENDER = "Male";
    static public String USER_DOB = "17 June,2006";
    static public String USER_NUMBER = "0123456789";
    static public String USER_SUBJECT = "Arts";
    static public String USER_HOBBY = "Sports";
    static public String USER_ADDRESS = "Floreni 18";
    static public String USER_STATE = "Haryana";
    static public String USER_CITY = "Panipat";
